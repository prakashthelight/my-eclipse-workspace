...
public class LeetCode014 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Longest Common Prefix using Binary Search: " + longestCommonPrefix(strs, 0, strs.length - 1));
	}
	...
	public static String longestCommonPrefix(String[] strs) {        
        ...
        // find common prefix between first and second element and keep reducing it if needed
