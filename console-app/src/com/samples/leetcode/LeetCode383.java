...
public class LeetCode383 {
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format("Can construct ransom note %s from %s : %s", ransomNote, magazine, canConstruct(ransomNote, magazine)));
	}

	/**
	 * returns true if given ransomNote can be made using characters in magazine.
	 * @param ransomNote
	 * @param magazine
	 * @return
	 */
